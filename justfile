...
test-arm64: _check-qemu test-claude-code-arm64 test-just-arm64 test-kiro-cli-arm64 test-nvidia-container-toolkit-arm64 test-act-arm64 test-gitlab-ci-local-arm64 test-prek-arm64
